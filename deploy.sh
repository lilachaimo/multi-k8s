...
kubectl set image deployments/client-deployment client=lilachyonash/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=lilachyonash/multi-worker:$SHA